            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: state == ThemeMode.light ? const Color(0xffb8e6db) : const Color(0xff204c5c),
                ),
              ),
              Container(
                width: MediaQuery.of(context).size.width/2,
                height: 80,
                decoration: BoxDecoration(
                  color: state == ThemeMode.light ? Colors.white :  const Color(0xff101c34),
                ),
              ),
            ],
          ),
          Column(
            children: [
              AppBar(
                ...
                toolbarHeight: 80,
                backgroundColor: state == ThemeMode.light ? const Color(0xffb8e6db) : const Color(0xff204c5c),
                elevation: 0,
                title: Row(
                  children: [
                    const SizedBox(
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: themeBloc == ThemeMode.light ? Colors.white : const Color(0xff101c34),
                  ),
                ),
              ),
            ],
